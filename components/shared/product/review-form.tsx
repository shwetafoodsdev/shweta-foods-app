...
export default function ReviewForm({ productId, action }: ReviewFormProps) {
  ...
  return (
    <form action={action} className="theme-surface mt-6 space-y-4 rounded-[1.5rem] border border-border/70 p-5 shadow-sm">
      ...
      <input
        className="w-full rounded-xl border border-border/70 bg-muted/40 px-4 py-3 outline-none transition-colors focus:border-primary/50"
        name="title"
