    ...
    <div>
      ...
      <div className="overflow-x-auto rounded border">
        <div className="min-w-[880px]">
          <div className="grid grid-cols-[110px_1fr_1fr_120px_230px] gap-3 bg-muted/40 p-3 text-xs font-semibold uppercase">
            <span>ID</span>
            <span>Name</span>
            <span>Email</span>
            <span>Role</span>
          ...
          {filteredUsers.length ? filteredUsers.map((user: AdminUser) => (
            <div key={user.id} className="grid grid-cols-[110px_1fr_1fr_120px_230px] gap-3 border-t p-3 items-center text-sm">
